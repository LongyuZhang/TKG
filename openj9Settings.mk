...
ifneq (, $(findstring current, $(JCL_VERSION)))
	ifeq (8, $(JDK_VERSION))
		...
		ifeq (default, $(VM_SUBDIR))
			CHECK_VM_SUBDIR=LIBPATH_VAL=$(LIBPATH_VAL); echo $(Q)$(JVM_OPTIONS)$(Q) | grep -q -- '-Xcompressedrefs' && LIBPATH_VAL=$$(echo $(Q)$$LIBPATH_VAL$(Q) | sed 's|/default:|/compressedrefs:|g; s|\\default;|\\compressedrefs;|g') && SQ=
