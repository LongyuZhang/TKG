...
ifneq (, $(findstring current, $(JCL_VERSION)))
	ifeq (8, $(JDK_VERSION))
		...
		JAVA_SHARED_LIBRARIES_DIR_VAL=$(Q)$(JAVA_SHARED_LIBRARIES_DIR_INIT)$(Q)
		CHECK_VM_SUBDIR=
		...
		ifeq (default, $(VM_SUBDIR))
			...
			CHECK_JAVA_SHARED_LIBRARIES_DIR=JAVA_SHARED_LIBRARIES_DIR_VAL=$(JAVA_SHARED_LIBRARIES_DIR_INIT); echo $(Q)$(JVM_OPTIONS)$(Q) | grep -q -- '-Xcompressedrefs' && JAVA_SHARED_LIBRARIES_DIR_VAL=$$(echo $(Q)$$JAVA_SHARED_LIBRARIES_DIR_INIT$(Q) | sed 's|/default:|/compressedrefs:|g; s|\\default;|\\compressedrefs;|g')
		endif
		ADD_JVM_LIB_DIR_TO_LIBPATH=$(CHECK_VM_SUBDIR) ; echo Set LIBPATH to $$LIBPATH_VAL && export LIBPATH=$$LIBPATH_VAL;
		JAVA_SHARED_LIBRARIES_DIR=$(CHECK_JAVA_SHARED_LIBRARIES_DIR); echo Set JAVA_SHARED_LIBRARIES_DIR to $$JAVA_SHARED_LIBRARIES_DIR_VAL && $$JAVA_SHARED_LIBRARIES_DIR_VAL
	else
		ifneq (,$(findstring win,$(SPEC)))
