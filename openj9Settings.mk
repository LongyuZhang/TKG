...
ifneq (, $(findstring current, $(JCL_VERSION)))
	ifeq (8, $(JDK_VERSION))
		...
		ADD_JVM_LIB_DIR_TO_LIBPATH=$(CHECK_VM_SUBDIR) ; echo Set LIBPATH to $$LIBPATH_VAL && export LIBPATH=$$LIBPATH_VAL; $(CHECK_JAVA_SHARED_LIBRARIES_DIR); echo Set JAVA_SHARED_LIBRARIES_DIR to $$JAVA_SHARED_LIBRARIES_DIR && export JAVA_SHARED_LIBRARIES_DIR=$$JAVA_SHARED_LIBRARIES_DIR; $$JAVA_SHARED_LIBRARIES_DIR
	else
		ifneq (,$(findstring win,$(SPEC)))
