...
ifneq (, $(findstring current, $(JCL_VERSION)))
	ifeq (8, $(JDK_VERSION))
		...
		JAVA_SHARED_LIBRARIES_DIR=true$(SQ)&&$(CHECK_JAVA_SHARED_LIBRARIES_DIR); echo Set JAVA_SHARED_LIBRARIES_DIR to $$JAVA_SHARED_LIBRARIES_DIR && export JAVA_SHARED_LIBRARIES_DIR=$$JAVA_SHARED_LIBRARIES_DIR; $$JAVA_SHARED_LIBRARIES_DIR$(SQ)
	else
		ifneq (,$(findstring win,$(SPEC)))
